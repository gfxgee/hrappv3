...
return [
    ...
    */
    ...
    'broadcasting' => [
        ...
        // Real-time database notifications over Laravel Reverb (Pusher protocol).
        // Only connects when the VITE_REVERB_* values are present, so the panel
        // works normally without a websocket server configured.
